...
class ExercisesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name_exercise' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'name_exercise' => 'Lorem ipsum dolor sit amet',
                'image' => 'Lorem ipsum dolor sit amet',
                'description' => 'Lorem ipsum dolor sit amet',
                'user_id' => 1,
                'created' => '2019-05-26 15:02:18',
                'modified' => '2019-05-26 15:02:18'
            ],
        ];
        parent::init();
    }
